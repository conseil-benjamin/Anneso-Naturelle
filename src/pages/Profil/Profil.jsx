    ...
    return (
        <>
            <div className="div-main-profil">
                ...
                <div className={"div-client-plus-password"}>
                    <div className="div-infos-client">
                        <div className="div-infos-perso">
                            ...
                            <button onClick={() => setIsInformationChanged(true)} disabled={!hasChanged}>Enregistrer
                                modifications
                            </button>
                        </div>
                    </div>
                    <div className="div-change-password">
                        <div style={{display: "flex", flexDirection: "column"}}>
                            ...
                            {isDataLoading ? <Loader></Loader> :
                                <button onClick={() => setBtnResetPassword(true)}>Confirmer changement mot de
                                    passe</button>
                            }
                        </div>
                    </div>
